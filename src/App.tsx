...
import { AppBar, Toolbar, Typography, Container, List, ListItemText, Box, CssBaseline, Paper, IconButton, Divider, BottomNavigation, BottomNavigationAction, ListItemButton } from '@mui/material';
        ...
        <Box sx={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row' }}>
          ...
          {isMobile && (
            ...
            >
              ...
              <BottomNavigationAction component={Link} to="/resume" label="Resume" icon={<ResumeIcon />} />
            </BottomNavigation>
          )}
        </Box>
      </Router>
